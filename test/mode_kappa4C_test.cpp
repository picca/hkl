...
Mode_Kappa4C_Test::Bissector(void)
{
    ...
    mode::kappa4C::vertical::Bissector mode;
...
Mode_Kappa4C_Test::Delta_Theta(void)
{
    ...
    mode::kappa4C::vertical::Delta_Theta mode;
...
{
    mode::kappa4C::vertical::Bissector bissector_ref, bissector;
    mode::kappa4C::vertical::Delta_Theta delta_theta_ref, delta_theta;
    mode::kappa4C::vertical::Constant_Omega constant_omega_ref, constant_omega;
    mode::kappa4C::vertical::Constant_Chi constant_chi_ref, constant_chi;
    mode::kappa4C::vertical::Constant_Phi constant_phi_ref, constant_phi;
    stringstream flux;
