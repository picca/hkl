...
Affinement_SimplexTest::Fit2(void)
{
  /*
      ...
      // Reflection 1
      _geometry.get_axe("2theta").set_value(30.398*hkl::constant::math::degToRad);
      ...
      // Reflection 2
      _geometry.get_axe("2theta").set_value(21.001*hkl::constant::math::degToRad);
      ...
      // Reflection 3
      _geometry.get_axe("2theta").set_value(54.046*hkl::constant::math::degToRad);
      ...
      // Reflection 4
      _geometry.get_axe("2theta").set_value(37.333*hkl::constant::math::degToRad);
