...
Mode_Kappa6C_Test::Bissector(void)
{
  ...
  CPPUNIT_ASSERT_EQUAL(hkl::Value(-60. * hkl::constant::math::degToRad), _geometry.komega()->get_current());
  ...
  CPPUNIT_ASSERT_EQUAL(hkl::Value(-60. * hkl::constant::math::degToRad), _geometry.komega()->get_current());
  CPPUNIT_ASSERT_EQUAL(hkl::Value(  0. * hkl::constant::math::degToRad), _geometry.kappa()->get_current());
  CPPUNIT_ASSERT_EQUAL(hkl::Value(270. * hkl::constant::math::degToRad), _geometry.kphi()->get_current());
  CPPUNIT_ASSERT_EQUAL(hkl::Value(  0. * hkl::constant::math::degToRad), _geometry.gamma()->get_current());
  CPPUNIT_ASSERT_EQUAL(hkl::Value( 60. * hkl::constant::math::degToRad), _geometry.delta()->get_current());
  ...
  CPPUNIT_ASSERT_EQUAL(hkl::Value(   0. * hkl::constant::math::degToRad), _geometry.mu()->get_current());
  CPPUNIT_ASSERT_EQUAL(hkl::Value(  -2.95484 * hkl::constant::math::degToRad), _geometry.komega()->get_current());
  ...
  CPPUNIT_ASSERT_NO_THROW(mode.computeAngles(0., 0., -1., UB));
  CPPUNIT_ASSERT_EQUAL(hkl::Value(   0. * hkl::constant::math::degToRad), _geometry.mu()->get_current());
  CPPUNIT_ASSERT_EQUAL(hkl::Value(-117.045165 * hkl::constant::math::degToRad), _geometry.komega()->get_current());
  CPPUNIT_ASSERT_EQUAL(hkl::Value( 134.755927 * hkl::constant::math::degToRad), _geometry.kappa()->get_current());
  ...
  CPPUNIT_ASSERT_EQUAL(hkl::Value(  0. * hkl::constant::math::degToRad), _geometry.kappa()->get_current());
  CPPUNIT_ASSERT_EQUAL(hkl::Value(225. * hkl::constant::math::degToRad), _geometry.kphi()->get_current());
  CPPUNIT_ASSERT_EQUAL(hkl::Value(  0. * hkl::constant::math::degToRad), _geometry.gamma()->get_current());
...
Mode_Kappa6C_Test::Delta_Theta(void)
{
  ...
  CPPUNIT_ASSERT_NO_THROW(mode.computeAngles(-1., 0., 0., UB));
  CPPUNIT_ASSERT_EQUAL(hkl::Value(  0. * hkl::constant::math::degToRad), _geometry.mu()->get_current());
  CPPUNIT_ASSERT_EQUAL(hkl::Value(-50. * hkl::constant::math::degToRad), _geometry.komega()->get_current());
  CPPUNIT_ASSERT_EQUAL(hkl::Value(  0. * hkl::constant::math::degToRad), _geometry.kappa()->get_current());
  CPPUNIT_ASSERT_EQUAL(hkl::Value(-10. * hkl::constant::math::degToRad), _geometry.kphi()->get_current());
  CPPUNIT_ASSERT_EQUAL(hkl::Value(  0. * hkl::constant::math::degToRad), _geometry.gamma()->get_current());
  CPPUNIT_ASSERT_EQUAL(hkl::Value( 60. * hkl::constant::math::degToRad), _geometry.delta()->get_current());
  ...
  CPPUNIT_ASSERT_EQUAL(hkl::Value(-50. * hkl::constant::math::degToRad), _geometry.komega()->get_current());
  CPPUNIT_ASSERT_EQUAL(hkl::Value(  0. * hkl::constant::math::degToRad), _geometry.kappa()->get_current());
  CPPUNIT_ASSERT_EQUAL(hkl::Value(260. * hkl::constant::math::degToRad), _geometry.kphi()->get_current());
  CPPUNIT_ASSERT_EQUAL(hkl::Value(  0. * hkl::constant::math::degToRad), _geometry.gamma()->get_current());
  CPPUNIT_ASSERT_EQUAL(hkl::Value( 60. * hkl::constant::math::degToRad), _geometry.delta()->get_current());
  ...
  CPPUNIT_ASSERT_NO_THROW(mode.computeAngles(1., 1., 0., UB));
  CPPUNIT_ASSERT_EQUAL(hkl::Value(  0. * hkl::constant::math::degToRad), _geometry.mu()->get_current());
  CPPUNIT_ASSERT_EQUAL(hkl::Value(-35. * hkl::constant::math::degToRad), _geometry.komega()->get_current());
  CPPUNIT_ASSERT_EQUAL(hkl::Value(  0. * hkl::constant::math::degToRad), _geometry.kappa()->get_current());
  CPPUNIT_ASSERT_EQUAL(hkl::Value(215. * hkl::constant::math::degToRad), _geometry.kphi()->get_current());
  CPPUNIT_ASSERT_EQUAL(hkl::Value(  0. * hkl::constant::math::degToRad), _geometry.gamma()->get_current());
  CPPUNIT_ASSERT_EQUAL(hkl::Value( 90. * hkl::constant::math::degToRad), _geometry.delta()->get_current());
