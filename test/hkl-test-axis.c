...
HKL_TEST_SUITE_FUNC( new_copy )
{
	...
	HKL_ASSERT_DOUBLES_EQUAL(0., axis->config.current, HKL_EPSILON);
	HKL_ASSERT_DOUBLES_EQUAL(0., axis->config.consign, HKL_EPSILON);
	...
	HKL_ASSERT_DOUBLES_EQUAL(0., copy->config.current, HKL_EPSILON);
	HKL_ASSERT_DOUBLES_EQUAL(0., copy->config.consign, HKL_EPSILON);
...
HKL_TEST_SUITE_FUNC( get_set_config )
{
	...
	HKL_ASSERT_DOUBLES_EQUAL(0., config.current, HKL_EPSILON);
	HKL_ASSERT_DOUBLES_EQUAL(0., config.consign, HKL_EPSILON);
	...
	HKL_ASSERT_DOUBLES_EQUAL(0.5, axis->config.current, HKL_EPSILON);
	HKL_ASSERT_DOUBLES_EQUAL(0.5, axis->config.consign, HKL_EPSILON);
	HKL_ASSERT_EQUAL(1, axis->config.dirty);
