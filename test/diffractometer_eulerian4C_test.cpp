...
DiffractometerEulerian4CTest::GetReciprocalLattice(void)
{
  ...
  m_d.setCrystalLattice("crystal", 1., 2., 3., 90. * HKL_DEGTORAD, 90. * HKL_DEGTORAD, 90. * HKL_DEGTORAD);
...
d->sethkl::AxeValue("2theta", 60.*HKL_DEGTORAD);
d->sethkl::AxeValue("omega", 30.*HKL_DEGTORAD);
d->sethkl::AxeValue("chi", 0.);
d->sethkl::AxeValue("phi", 90.*HKL_DEGTORAD);
d->addCrystalReflection("crystal1", 1., 0., 0., Reflection::Best, true);

CPPUNIT_ASSERT_THROW(d->computeU(), HKLException);

d->sethkl::AxeValue("phi", 180.*HKL_DEGTORAD);
...
DiffractometerEulerian4CTest::ComputeHKL(void)
{
  ...
  m_d.sethkl::AxeValue("2theta", 60.*HKL_DEGTORAD);
  m_d.sethkl::AxeValue("omega", 30.*HKL_DEGTORAD);
  m_d.sethkl::AxeValue("chi", 0.);
  m_d.sethkl::AxeValue("phi", 90.*HKL_DEGTORAD);
  m_d.addCrystalReflection("crystal1", 1., 0., 0., Best, true);

  m_d.sethkl::AxeValue("phi", 180.*HKL_DEGTORAD);
  ...
  m_d.sethkl::AxeValue("2theta", 180.*HKL_DEGTORAD);
  m_d.sethkl::AxeValue("omega", 90.*HKL_DEGTORAD);
  m_d.computeHKL(h, k, l);
...
DiffractometerEulerian4CTest::ComputeAngles(void)
{
  ...
  CPPUNIT_ASSERT_DOUBLES_EQUAL(60*HKL_DEGTORAD, m_d.gethkl::AxeValue("2theta"), hkl::constant::math::epsilon_0);
  CPPUNIT_ASSERT_DOUBLES_EQUAL(30*HKL_DEGTORAD, m_d.gethkl::AxeValue("omega"), hkl::constant::math::epsilon_0);
  CPPUNIT_ASSERT_DOUBLES_EQUAL(0, m_d.gethkl::AxeValue("chi"), hkl::constant::math::epsilon_0);
  CPPUNIT_ASSERT_DOUBLES_EQUAL(90*HKL_DEGTORAD, m_d.gethkl::AxeValue("phi"), hkl::constant::math::epsilon_0);
}
...
DiffractometerEulerian4CTest::LPS(void)
{
  ...
  m_d.sethkl::AxeValue("2theta", 30.391991*HKL_DEGTORAD);
  m_d.sethkl::AxeValue("omega", 15.195995*HKL_DEGTORAD);
  m_d.sethkl::AxeValue("chi", 90.*HKL_DEGTORAD);
  m_d.sethkl::AxeValue("phi", 0.*HKL_DEGTORAD);
  m_d.addCrystalReflection("orthorombique", 0., 0., 1., Best, true);

  m_d.sethkl::AxeValue("2theta", 10.445403*HKL_DEGTORAD);
  m_d.sethkl::AxeValue("omega", 5.2227013*HKL_DEGTORAD);
  m_d.sethkl::AxeValue("chi", 0.*HKL_DEGTORAD);
  m_d.sethkl::AxeValue("phi", 0.*HKL_DEGTORAD);
  ...
  CPPUNIT_ASSERT_DOUBLES_EQUAL(10.445403*HKL_DEGTORAD, m_d.gethkl::AxeValue("2theta"), hkl::constant::math::epsilon_0);
  CPPUNIT_ASSERT_DOUBLES_EQUAL(5.2227013*HKL_DEGTORAD, m_d.gethkl::AxeValue("omega"), hkl::constant::math::epsilon_0);
  CPPUNIT_ASSERT_DOUBLES_EQUAL(0*HKL_DEGTORAD, m_d.gethkl::AxeValue("chi"), hkl::constant::math::epsilon_0);
  CPPUNIT_ASSERT_DOUBLES_EQUAL(0*HKL_DEGTORAD, m_d.gethkl::AxeValue("phi"), hkl::constant::math::epsilon_0);
}
...
DiffractometerEulerian4CTest::LPS2(void)
{
  ...
  // Reflection 1
  m_d.sethkl::AxeValue("2theta", 30.398*HKL_DEGTORAD);
  m_d.sethkl::AxeValue("omega", 11.709*HKL_DEGTORAD);
  m_d.sethkl::AxeValue("chi", 87.607*HKL_DEGTORAD);
  m_d.sethkl::AxeValue("phi", 0.265*HKL_DEGTORAD);
  m_d.addCrystalReflection("orthorombique", 0., 0., 1., Best, true);

  // Reflection 2
  m_d.sethkl::AxeValue("2theta", 21.001*HKL_DEGTORAD);
  m_d.sethkl::AxeValue("omega", 10.322*HKL_DEGTORAD);
  m_d.sethkl::AxeValue("chi", -2.139*HKL_DEGTORAD);
  m_d.sethkl::AxeValue("phi", 0.023*HKL_DEGTORAD);
  m_d.addCrystalReflection("orthorombique", 0., 2., 0., Best, true);

  // Reflection 3
  m_d.sethkl::AxeValue("2theta", 54.046*HKL_DEGTORAD);
  m_d.sethkl::AxeValue("omega", 26.872*HKL_DEGTORAD);
  m_d.sethkl::AxeValue("chi", 34.938*HKL_DEGTORAD);
  m_d.sethkl::AxeValue("phi", 57.295*HKL_DEGTORAD);
  m_d.addCrystalReflection("orthorombique", -2., 2., 1., Best, true);

  // Reflection 4
  m_d.sethkl::AxeValue("2theta", 37.333*HKL_DEGTORAD);
  m_d.sethkl::AxeValue("omega", 18.51*HKL_DEGTORAD);
  m_d.sethkl::AxeValue("chi", 53.966*HKL_DEGTORAD);
  m_d.sethkl::AxeValue("phi", 54.505*HKL_DEGTORAD);
