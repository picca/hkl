...
namespace hkl {
    ...
    class BaseObject
      ...
      protected:
         ...
         */
        MyString const & _get_name(void) const {return m_name;}

        /*!
         * \brief Get the description of the BaseObject.
         * \return a MyString with the description of the BaseObject.
         */
        MyString const & _get_description(void) const {return m_description;}
    ...
    public :
       ...
       * \return a MyString with the name of the Object.
       */
      MyString const & get_name(void) const {return _get_name();}

      /*!
       * \brief Get the description of the Object.
       * \return a MyString with the description of the Object.
       */
      MyString const & get_description(void) const {return _get_description();}
