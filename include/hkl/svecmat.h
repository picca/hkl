...
/// Define a vector in a three dimensionnal space.
  class svector
    ...
    public:
      ...
      /**
       * @brief Get the x part of the svector
       * @return x
       */
      double & x(void)
      {
      ...
      /**
       * @brief Get the y part of the svector
       * @return y
       */
      double & y(void)
      {
      ...
      /**
       * @brief Get the z part of the svector
       * @return z
       */
      double & z(void)
      {
      ...
      /**
       * @brief Get a constant reference on the x part of the svector
       * @return x
       */
      ...
      /**
       * @brief Get a constant reference on the y part of the svector
       * @return y
       */
      ...
      /**
       * @brief Get a constant reference on the z part of the svector
       * @return z
       */
      ...
      /**
       * @brief  Substract a vector element by element.
      ...
      /**
       * @brief Compute the sum of all vector's elements.
       * @return x+y+z
       */
      ...
      /**
       * @brief Are two vectors colinear.
       * @param v The vector to compare with.
       * @return true if both vectors are colinear.
       */
      ...
      /**
       * @brief print the svector into a flux
    ...
    protected :
      double _x; //!< The x part of the vector.
      double _y; //!< The y part of the vector.
      double _z; //!< The z part of the vector.
    };
...
/// Define a matrix in a three dimensionnal space.
  class smatrix
    ...
    public:
      ...
      /**
      * @brief Set the matrix using the eulerian rotation angles.
      * 
      * @param rx The rotation around Ox.
      * @param ry The rotation around Oy.
      * @param rz The rotation around Oz.
      */
