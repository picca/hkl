...
namespace hkl
  ...
  namespace kappa4C
    ...
    namespace vertical
      ...
      inline void kappa_to_eulerian_range(hkl::Range const & komega, hkl::Range const & kappa, hkl::Range const & kphi, double const & alpha, hkl::Interval & omega, hkl::Interval & chi, hkl::Interval & phi, bool solution = SOLUTION)
      {
