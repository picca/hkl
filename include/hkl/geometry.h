...
namespace hkl
{
	...
	class Geometry : public hkl::HKLObject
	{
		...
		public:
			 ...
			 * @return the AxeList
			 */
			inline hkl_axes const * get_axes() const;
			 ...
			 */
			hkl_axis * get_axe(const std::string & name) throw(hkl::HKLException);
			 ...
			 * @throw hkl::HKLException if the hkl::Axe does not exist.
			 */
			hkl_axis * get_axe(const std::string & name) const throw(hkl::HKLException);
	 ...
	 * @return the AxeList
	 */
	inline hkl_axes const * Geometry::get_axes() const
	{
