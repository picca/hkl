...
namespace hkl
  ...
  class PseudoAxeEngine : public HKLObject
    ...
    public:
      ...
      protected:
        PseudoAxeEngine(MyString const & name, MyString const & description);
    };
  ...
  class PseudoAxeEngineTemp : public PseudoAxeEngine, public Observer
    ...
    protected:
      ...
      vector<Range *> _ranges; //!< The ranges used to store the pseudoAxes Values.
       ...
       */
      PseudoAxeEngineTemp(T & geometry, MyString const & name, MyString const & description,
                      vector<string> const & names, bool initialized, bool readable, bool writable) :
          PseudoAxeEngine(name, description),
          Observer(),
          _geometry(geometry),
