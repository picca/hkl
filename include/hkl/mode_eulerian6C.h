    ...
    namespace eulerian6C
      ...
      namespace eulerian4C
        ...
        namespace vertical
          ...
          typedef DerivedMode<mode::eulerian4C::vertical::Bissector, geometry::Eulerian6C> Bissector; //!< Derived PseudoAxe from eulerian4C PseudoAxe.
          typedef DerivedMode<mode::eulerian4C::vertical::Delta_Theta, geometry::Eulerian6C> Delta_Theta; //!< Derived PseudoAxe from eulerian4C PseudoAxe.
          typedef DerivedMode<mode::eulerian4C::vertical::Constant_Omega, geometry::Eulerian6C> Constant_Omega; //!< Derived PseudoAxe from eulerian4C PseudoAxe.
          typedef DerivedMode<mode::eulerian4C::vertical::Constant_Chi, geometry::Eulerian6C> Constant_Chi; //!< Derived PseudoAxe from eulerian4C PseudoAxe.
          typedef DerivedMode<mode::eulerian4C::vertical::Constant_Phi, geometry::Eulerian6C> Constant_Phi; //!< Derived PseudoAxe from eulerian4C PseudoAxe.
