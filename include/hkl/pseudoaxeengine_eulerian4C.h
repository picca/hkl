    ...
    namespace eulerian4C
      ...
      namespace vertical
        ...
        class Psi : public PseudoAxeEngineTemp<geometry::eulerian4C::Vertical>
          ...
          private:
            Axe * & _omega; //!< The omega axe usr for calculation.
            Axe * & _chi; //!< The chi axe usr for calculation.
            Axe * & _phi; //!< The phi axe usr for calculation.
            Axe * & _tth; //!< The tth axe usr for calculation.
