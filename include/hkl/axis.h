...
extern double hkl_axes_get_distance(struct hkl_axes const * axes1, struct hkl_axes const * axes2);

extern double hkl_axes_get_distance_consign(struct hkl_axes const * axes1, struct hkl_axes const * axes2);
