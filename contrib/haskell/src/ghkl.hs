...
-- data HklFactory
newtype HklFactory = HklFactory (Ptr ()) deriving (Show, Storable)
...
foreign import ccall safe "hkl.h hkl_factory_name_get"
        c_hkl_factory_name_get :: Ptr HklFactory -> IO CString

hklFactoryNameGet :: HklFactory -> IO String
hklFactoryNameGet factory = peekCString $ c_hkl_factory_name_get $ poke factory
