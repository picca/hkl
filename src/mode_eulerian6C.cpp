    ...
    namespace eulerian6C {
      namespace horizontal4C {
        ...
        void 
          ...
          {
            m_aC_Eulerian4C["omega"].set_value(aC["mu"].get_value());
            m_aC_Eulerian4C["chi"].set_value(aC["chi"].get_value());
            m_aC_Eulerian4C["phi"].set_value(aC["phi"].get_value());
            m_aC_Eulerian4C["2theta"].set_value(aC["gamma"].get_value());

#ifdef VCPP6
			((mode::eulerian4C::Bissector *)this)->computeAngles(h, k, l, UB, lambda, m_aC_Eulerian4C);
#else
            mode::eulerian4C::Bissector::computeAngles(h, k, l, UB, lambda, m_aC_Eulerian4C);
#endif
            aC["mu"].set_value(m_aC_Eulerian4C["omega"].get_value());
            aC["chi"].set_value(m_aC_Eulerian4C["chi"].get_value());
            aC["phi"].set_value(m_aC_Eulerian4C["phi"].get_value());
            aC["gamma"].set_value(m_aC_Eulerian4C["2theta"].get_value());
...
#ifdef VCPP6
            ((mode::eulerian4C::Delta_Theta *)this)->computeAngles(h, k, l, UB, lambda, m_aC_Eulerian4C);
#else
            mode::eulerian4C::Delta_Theta::computeAngles(h, k, l, UB, lambda, m_aC_Eulerian4C);
#endif
            aC["mu"].set_value(m_aC_Eulerian4C["omega"].get_value());
            aC["chi"].set_value(m_aC_Eulerian4C["chi"].get_value());
            aC["phi"].set_value(m_aC_Eulerian4C["phi"].get_value());
...
#ifdef VCPP6
            ((mode::eulerian4C::Constant_Omega *)this)->computeAngles(h, k, l, UB, lambda, m_aC_Eulerian4C);
#else
            mode::eulerian4C::Constant_Omega::computeAngles(h, k, l, UB, lambda, m_aC_Eulerian4C);
#endif
            aC["mu"].set_value(m_aC_Eulerian4C["omega"].get_value());
            aC["chi"].set_value(m_aC_Eulerian4C["chi"].get_value());
            aC["phi"].set_value(m_aC_Eulerian4C["phi"].get_value());
...
#ifdef VCPP6
            ((mode::eulerian4C::Constant_Chi *)this)->computeAngles(h, k, l, UB, lambda, m_aC_Eulerian4C);
#else
            mode::eulerian4C::Constant_Chi::computeAngles(h, k, l, UB, lambda, m_aC_Eulerian4C);
#endif
            aC["mu"].set_value(m_aC_Eulerian4C["omega"].get_value());
            aC["chi"].set_value(m_aC_Eulerian4C["chi"].get_value());
            aC["phi"].set_value(m_aC_Eulerian4C["phi"].get_value());
...
#ifdef VCPP6
            ((mode::eulerian4C::Constant_Phi *)this)->computeAngles(h, k, l, UB, lambda, m_aC_Eulerian4C);
#else
            mode::eulerian4C::Constant_Phi::computeAngles(h, k, l, UB, lambda, m_aC_Eulerian4C);
#endif
            aC["mu"].set_value(m_aC_Eulerian4C["omega"].get_value());
            aC["chi"].set_value(m_aC_Eulerian4C["chi"].get_value());
            aC["phi"].set_value(m_aC_Eulerian4C["phi"].get_value());
      ...
      namespace vertical4C {
        ...
        void 
          Bissector::computeAngles(double h, double k, double l,
              ...
              AngleConfiguration & aC) const throw (HKLException)
          {
            m_aC_Eulerian4C["omega"].set_value(aC["omega"].get_value());
            m_aC_Eulerian4C["chi"].set_value(aC["chi"].get_value());
            m_aC_Eulerian4C["phi"].set_value(aC["phi"].get_value());
            m_aC_Eulerian4C["2theta"].set_value(aC["delta"].get_value());
            ...
            mode::eulerian4C::Bissector::computeAngles(h, k, l, UB, lambda, m_aC_Eulerian4C);
#endif
            aC["omega"].set_value(m_aC_Eulerian4C["omega"].get_value());
            aC["chi"].set_value(m_aC_Eulerian4C["chi"].get_value());
            aC["phi"].set_value(m_aC_Eulerian4C["phi"].get_value());
            aC["delta"].set_value(m_aC_Eulerian4C["2theta"].get_value());
      ...
      void
            ...
            AngleConfiguration & aC) const throw (HKLException)
        {
          ...
          if (fabs(cos_delta) < constant::math::epsilon_1)
          {
            ...
            aC["gamma"].set_value(gamma);
            aC["delta"].set_value(delta);
