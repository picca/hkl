...
void hkl_smatrix_from_two_svector(struct hkl_smatrix * m, struct hkl_svector const * v1, struct hkl_svector const * v2)
{
  struct hkl_svector x, y, z;
...
void hkl_smatrix_from_euler(struct hkl_smatrix * m, double euler_x, double euler_y, double euler_z)
{
...
void hkl_smatrix_to_euler(struct hkl_smatrix const * m, double * euler_x, double * euler_y, double * euler_z)
{
  double tx, ty;
  double C;
...
int hkl_smatrix_cmp(struct hkl_smatrix const * m, struct hkl_smatrix const * m1)
{
  unsigned int i;
  unsigned int j;
  for (i=0;i<3;i++)
...
void hkl_smatrix_times_smatrix(struct hkl_smatrix * m, struct hkl_smatrix const * m1)
{
  struct hkl_smatrix M;
  struct hkl_smatrix const * M1;
  M = *m;
  if (m == m1)
    M1 = &M;
  else
...
void hkl_smatrix_times_svector(struct hkl_smatrix const * m, struct hkl_svector * v)
{
...
void hkl_smatrix_transpose(struct hkl_smatrix * m)
{
...
/** @todo test */
double hkl_smatrix_det(struct hkl_smatrix const * m)
{
  double det;
...
/** @todo test */
int hkl_smatrix_solve(struct hkl_smatrix const * m, struct hkl_svector * x, struct hkl_svector const * b)
{
  double det;
