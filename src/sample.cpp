...
Sample::Sample(hkl::Geometry & geometry, const std::string & name) :
  ...
  _geometry(geometry)
{
  // Bouml preserved body begin 0002D402
  ...
  // Bouml preserved body end 0002D402
}

Sample::~Sample() 
{
  // Bouml preserved body begin 0002ED82
  // Bouml preserved body end 0002ED82
}
...
{
  // Bouml preserved body begin 0002D482
      _parameters.push_back(&_lattice.a());
      _parameters.push_back(&_lattice.b());
      _parameters.push_back(&_lattice.c());
      _parameters.push_back(&_lattice.alpha());
      _parameters.push_back(&_lattice.beta());
      _parameters.push_back(&_lattice.gamma());
  // Bouml preserved body end 0002D482
}
...
{
  // Bouml preserved body begin 0002E102
      return _lattice;
  // Bouml preserved body end 0002E102
}
...
{
  // Bouml preserved body begin 0002E182
      return *_reflections;
  // Bouml preserved body end 0002E182
}
...
std::ostream & Sample::toStream(std::ostream & flux) const 
{
  // Bouml preserved body begin 0002E302
      ...
      return flux;
  // Bouml preserved body end 0002E302
}
...
std::istream & Sample::fromStream(std::istream & flux) 
{
  // Bouml preserved body begin 0002E382
      ...
      return flux;
  // Bouml preserved body end 0002E382
}
