        ...
        for(i=0;i<3;i++)
          {
            ...
            flux.width(9); flux << p.get_current().get_value();
            flux.width(9); flux << p.get_min().get_value();
            flux.width(9); flux << p.get_max().get_value();
            flux << endl;
          }
        for(i=3;i<6;i++)
          {
            ...
            flux.precision(3);
            flux.width(9); flux << p.get_name() << "(" << p.get_flagFit() << "):";
            flux.width(9); flux << p.get_current().get_value()*constant::math::radToDeg;
            flux.width(9); flux << p.get_min().get_value()*constant::math::radToDeg;
            flux.width(9); flux << p.get_max().get_value()*constant::math::radToDeg;
            flux << endl;
          }
