...
{
  // Bouml preserved body begin 00027A02
  // Bouml preserved body end 00027A02
}
...
{
  // Bouml preserved body begin 00027A82
  ...
  // Bouml preserved body end 00027A82
}
...
{
  // Bouml preserved body begin 00027C82
  ...
  // Bouml preserved body end 00027C82
}
...
{
  // Bouml preserved body begin 00027D02
  ...
  // Bouml preserved body end 00027D02
}
...
{
  // Bouml preserved body begin 00027D82
      double k = constant::physic::tau / _waveLength;
      ...
      return ki;
  // Bouml preserved body end 00027D82
}
...
{
  // Bouml preserved body begin 00027E02
      if (ki == svector())
  ...
  // Bouml preserved body end 00027E02
}
...
{
  // Bouml preserved body begin 00027E82
      return _waveLength == source._waveLength
             && _direction == source._direction
             && _qi == source._qi;
  // Bouml preserved body end 00027E82
}
...
std::ostream & Source::printToStream(std::ostream & flux) const 
{
  // Bouml preserved body begin 00027F02
      ...
      return flux;
  // Bouml preserved body end 00027F02
}
...
std::ostream & Source::toStream(std::ostream & flux) const 
{
  // Bouml preserved body begin 00027F82
      ...
      return flux;
  // Bouml preserved body end 00027F82
}
...
std::istream & Source::fromStream(std::istream & flux) 
{
  // Bouml preserved body begin 00028002
      ...
      return flux;
  // Bouml preserved body end 00028002
}
