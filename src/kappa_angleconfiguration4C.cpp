...
// $Source: /usr/local/CVS/Libraries/HKL/src/Attic/kappa_angleconfiguration4C.cpp,v $
...
// Description:  C++ source code for the class kappa_angleConfiguration4C
...
// $Log: kappa_angleconfiguration4C.cpp,v $
