...
extern HklPseudoAxisEngine *hkl_pseudo_axis_engine_soleil_sirius_kappa_hkl_new(void);
extern HklPseudoAxisEngine *hkl_pseudo_axis_engine_soleil_sirius_kappa_psi_new(void);
