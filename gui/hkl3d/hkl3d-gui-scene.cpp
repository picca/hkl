...
namespace Glib
{
  /** @relates Hkl3dGui::Scene
   * @param object The C instance
   * @param take_copy False if the result should take ownership of the C instance. True if it should take a new copy or ref.
   * @result A C++ instance that wraps this C instance.
   */
	// Glib::RefPtr<Hkl3dGui::Scene> wrap(HklGui3DScene* object, bool take_copy = false)
	// {
	// 	return Glib::RefPtr<Hkl3dGui::Scene>( dynamic_cast<Hkl3dGui::Scene *> (Glib::wrap_auto ((GObject*)(object), take_copy)) );
	// }

	Hkl3dGui::Scene *wrap(HklGui3DScene* object, bool take_copy = false)
	{
		return dynamic_cast<Hkl3dGui::Scene *> (Glib::wrap_auto ((GObject*)(object), take_copy));
	}
} // namespace Glib
...
extern "C" {
	...
	{
		Hkl3dGui::Scene *t = new Hkl3dGui::Scene(hkl3d, enableBulletDraw, enableWireframe, enableAAbbBoxDraw, enableOrthoView);

		return (HklGui3DScene *)t->gobj();
	}

	void hkl_gui_3d_scene_free(HklGui3DScene *self)
	{
		Hkl3dGui::Scene *t = Glib::wrap(self);
	...
	{
		Gtk::Main *_GTKMain = new Gtk::Main(0, 0, false);
